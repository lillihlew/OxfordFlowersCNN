...
data_train, data_validation, data_test, class_names = load_oxford_flowers102(imsize=96, fine=False) #coarse
...
net_save_name = save_name + '_pt1_coarse_cnn_net.h5'
history_save_name = save_name + '_pt1_coarse_cnn_net.hist'
